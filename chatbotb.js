...
class ChatBot {
    constructor() {
        ...
        // ****************************************************************
        this.webhookUrl = 'https://brickastley.app.n8n.cloud/webhook/chatb';
        // ****************************************************************        
                ...
                <div class="chatbot-panel" id="chatbotPanel">
                    <div class="chatbot-header">
                        <div class="chatbot-title">
                            ...
                            <span>alexander hamiltonAI課程聊天BOT</span>
                        </div>
    ...
    loadChatHistory() {
        ...
        if (recentHistory.length === 0) {
            ...
            setTimeout(() => {
                this.addMessage('你好！我是alexander hamilton的AI課程助手。有任何問題嗎？', 'ai');
            }, 1000);
        }
    }
